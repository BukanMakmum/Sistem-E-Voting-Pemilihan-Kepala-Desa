...
<head>
	...
	<title>Dashboard Admin - Sistem E-Voting Pemilihan Geuchik</title>
				...
				<ul class="nav navbar-nav">
					<li class="dropdown dropdown-user">
						<a class="dropdown-toggle" data-toggle="dropdown">
							...
							Anda Login Sebagai : <span class="text-bold"><?php echo $_SESSION['nama']; ?> (Admin)</span>
							<i class="caret"></i>
						</a>
				...
				<div class="sidebar-content">
					...
					<div class="sidebar-user">
						<div class="category-content">
							<div class="media">
								<a href="#" class="media-left"><img src="../images/opsi/admin.jpg" class="img-circle img-sm" alt=""></a>
						...
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									...
									<ul>										
										<li><a href="pengawas.php"><i class="icon-users2"></i> <span>&nbsp; Data Pengawas</span></a></li>
								...
								<li><a href="jadwal_voting.php"><i class=" icon-alarm-check"></i> <span>Jadwal Voting</span></a></li>
								<!--<li><a href="agenda.php"><i class=" icon-calendar3"></i> <span>Agenda Kegiatan</span></a></li>-->
								
								<li>
									<a href="#"><i class="icon-list"></i> <span>Posting</span></a>
									<ul>										
										<li><a href="kategori.php"><i class="glyphicon glyphicon-tags"></i> <span>&nbsp; Kategori</span></a></li>
										<li><a href="posting.php"><i class="glyphicon glyphicon-pencil"></i> <span>&nbsp; Posting</span></a></li>																	
									</ul>
								</li>							
