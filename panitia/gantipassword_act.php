...
$cek = mysqli_query($config,"select * from panitia where panitia_password='$password_lama'");
	...
	if(strlen($password_baru) >= 8){
		...
		if($password_baru == $konfirmasi_password){
			...
			$password_baru 	= md5($password_baru);
					...
					$update = mysqli_query($config,"update panitia set panitia_password='$password_baru' where panitia_id='$id'");
