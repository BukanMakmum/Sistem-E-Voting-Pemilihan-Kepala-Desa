...
<head>
	...
	<title>Dashboard Panitia - Sistem E-Voting Pemilihan Geuchik</title>
	...
	<link href="../assets/css/ajaxmask.css" rel="stylesheet" type="text/css">
				...
				<ul class="nav navbar-nav">
					<li class="dropdown dropdown-user">
						<a class="dropdown-toggle" data-toggle="dropdown">
							...
							Anda Login Sebagai : <span class="text-bold"><?php echo $_SESSION['nama']; ?> (Panitia)</span>
							<i class="caret"></i>
						</a>

						<ul class="dropdown-menu dropdown-menu-right">
							<li><a href="panitia_profil.php?id="><i class="icon-user"></i> <span>Profil</span></a></li>
					...
					<div class="sidebar-user">
						<div class="category-content">
							<div class="media">
								...
								$user = mysqli_query($config,"select * from panitia where panitia_id='$id_session'");
								$u = mysqli_fetch_assoc($user);
								?>
								<a href="panitia_profil.php?id=" class="media-left"><img src="../images/panitia/<?php echo $u['panitia_gambar'];  ?>" class="img-circle img-sm" alt=""></a>
							...
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li><a href="#"><i class="icon-stack2"></i> <span>Data Master</span></a>
									<ul>																				
										...
										<li><a href="pengawas.php"><i class="icon-users"></i> <span>&nbsp; Data Pengawas</span></a></li>
